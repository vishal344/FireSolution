...
public class TC_DeliveryChallan_0017_3 extends BaseClass {
	...
	public void Deliverychallan() throws InterruptedException {
		...
		WebElement option3 = driver.findElement(By.xpath("//input[@id='option4']"));

		if (!option3.isSelected()) {

			option3.click();

			WebElement searchBox = driver.findElement(By.xpath("//input[@id='first-site1']"));
			searchBox.click();
			...
			List<WebElement> results = driver.findElements(By.xpath("(//div[@class='autocomplete-suggestions'])[1]"));
			...
			sitewait.until(ExpectedConditions
					.presenceOfElementLocated(By.xpath("(//div[@class='autocomplete-suggestions'])[2]")));

			// Click the specific suggestion
			List<WebElement> siteresults = driver
					.findElements(By.xpath("(//div[@class='autocomplete-suggestions'])[2]"));
