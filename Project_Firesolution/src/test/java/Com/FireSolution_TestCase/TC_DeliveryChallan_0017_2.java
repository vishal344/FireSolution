...
public class TC_DeliveryChallan_0017_2 extends BaseClass {
	...
	public void Deliverychallan() throws InterruptedException {
		...
		WebElement option2 = driver.findElement(By.xpath("//input[@id='option2']"));
		...
		if (!option2.isSelected()) {
			...
			WebElement warehousesearch = driver.findElement(By.xpath("//input[@id='Second-warehouse1']"));
			warehousesearch.click();
			warehousesearch.sendKeys("ware");

			// Wait for suggestions
			WebDriverWait warehousewait = new WebDriverWait(driver, Duration.ofSeconds(30));
			warehousewait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("(//div[@class='autocomplete-suggestions'])[2]")));

			// Click the specific suggestion
			List<WebElement> warehouseresults = driver.findElements(By.xpath("(//div[@class='autocomplete-suggestions'])[2]"));
			...
			WebElement qty = driver.findElement(By.xpath("(//input[@name='qty[]'])[1]"));
