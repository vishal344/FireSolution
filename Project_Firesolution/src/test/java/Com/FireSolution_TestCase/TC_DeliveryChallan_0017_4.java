...
public class TC_DeliveryChallan_0017_4 extends BaseClass {
	...
	public void Deliverychallan() throws InterruptedException {
		...
		WebElement option4 = driver.findElement(By.xpath("//input[@id='option5']"));

		if (!option4.isSelected()) {

			option4.click();

			WebElement sitesearchBox = driver.findElement(By.xpath("//input[@id='first-site1']"));
			sitesearchBox.click();
			...
			WebElement warehousesearchBox = driver.findElement(By.xpath("//input[@id='Second-warehouse1']"));
